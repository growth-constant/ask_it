...
class AnswerTest < ActiveSupport::TestCase
  ...
  test 'should create an answer with a option_number field for options with number type' do
    ...
    answer_try1 = create_answer(option: option, attempt: attempt, question: question, option_number: 12)

    should_be_persisted survey
    should_be_persisted answer_try1
  end
  ...
  test 'should not create an answer with a nil option_number field for options with number type' do
    ...
    answer_try1 = create_answer(option: option, attempt: attempt, question: question, option_number: nil)

    should_be_persisted survey
    should_not_be_persisted answer_try1
  end
  ...
  test 'should create an answer with a option_text field for options with text type' do
    ...
    answer_try1 = create_answer(option: option, attempt: attempt, question: question, option_text: Faker::Name.name)
  ...
  test 'should not create an answer with a nil option_text field for options with text type' do
    survey, option, attempt, question = create_answer_with_option_type(AskIt::OptionsType.text, true)
    answer_try1 = create_answer(option: option, attempt: attempt, question: question, option_text: nil)
  ...
  test 'should create an answer with a option_text field for options with multi_choices_with_text type' do
    ...
    answer_try1 = create_answer(option: option, attempt: attempt, question: question, option_text: faker_name)

    should_be_persisted survey
    should_be_persisted answer_try1
    assert_equal answer_try1.option_text, faker_name
  end
  ...
  test 'should not create an answer with empty option_number field for options with multi_choices_with_number type' do
    survey, option, attempt, question = create_answer_with_option_type(AskIt::OptionsType.multi_choices_with_number,
                                                                       true)
    answer_try1 = create_answer(option: option, attempt: attempt, question: question, option_number: nil)
  ...
  test 'should not create an answer with empty option_number field for options with single_choice_with_number type' do
    survey, option, attempt, question = create_answer_with_option_type(AskIt::OptionsType.single_choice_with_number,
                                                                       true)
    answer_try1 = create_answer(option: option, attempt: attempt, question: question, option_number: nil)
  ...
  test 'should create an answer with options with multi_choices type, and text field should be empty' do
    ...
    should_be_persisted survey
    should_be_persisted answer_try1
    assert_equal answer_try1.option_text, nil
  end
  ...
  test 'should create an answer with a predefined_value_id field for single_choice type' do
    ...
    question.save
    answer_try1 = create_answer(option: option, attempt: attempt, question: question,
                                predefined_value_id: predefined_value.id)

    should_be_persisted survey
    should_be_persisted question
    should_be_persisted answer_try1
    assert_equal answer_try1.predefined_value_id, predefined_value.id
  end
  ...
  test 'should not create an answer with an empty predefined_value_id field for single_choice type' do
    ...
    question.save
    answer_try1 = create_answer(option: option, attempt: attempt, question: question, predefined_value_id: nil)
  ...
  test 'can create an answer already made to the same attempt' do
    answer_try1 = create_answer
    attempt  = answer_try1.attempt
    question = answer_try1.question
    option   = (question.options - [answer_try1.option]).first
    answer_try2 = create_answer(attempt: attempt, question: question, option: option)

    should_be_persisted answer_try1
    should_be_persisted answer_try2
  end
end
